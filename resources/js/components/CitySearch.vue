...
<template>
    <div ref="searchContainer" class="relative w-full max-w-xs">
        <div class="relative">
            ...
            />
            <Button v-if="search" variant="ghost" size="icon" class="absolute inset-y-0 right-0 h-auto w-auto px-3" @click="clearSearch">
                <X class="h-4 w-4" />
            </Button>
        </div>

        <Card v-if="displayResults" class="absolute z-10 mt-1 w-full shadow-lg">
            <ul class="max-h-60 overflow-auto py-1">
                <li
                    ...
                    :class="[
                        ...
                        selectedIndex === index ? 'bg-primary text-primary-foreground' : 'hover:bg-neutral-100 dark:hover:bg-neutral-800',
                    ]"
